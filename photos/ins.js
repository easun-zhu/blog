    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'http://blog-photos.oss-cn-shanghai.aliyuncs.com/min_photos/' + data.link[i];
          var src = 'http://blog-photos.oss-cn-shanghai.aliyuncs.com/src_photos/' + data.link[i];
